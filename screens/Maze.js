...
const getOverLappingCells = (x, y, maze) => {
  ...
  const cells = uniqWith(
    (a, b) => (a && a.x) === (b && b.x) && (a && a.y) === (b && b.y),
...
export default ({ xAcceleration, yAcceleration, width, height }) => {
  ...
  return (
    <View onPress={go} style={{ width, height, position: "absolute" }}>
      {maze.map((row) =>
          ...
          return (
            <View
              ...
              style={{
                ...
                width: cellSize,
                height: cellSize,
                // borderTop: top ? 2 + "black solid" : "none",
                // borderLeft: left ? 2 + " black solid" : "none",
                // borderBottom: bottom ? 2 + " black solid" : "none",
                // borderRight: right ? 2 + " black solid" : "none",
