...
const ZielenTraining2 = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.header_bigtext}>Training : Zielen</Text>
      </View>
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate("ZielenTrainingExercise", {
              id: id,
              score: score,
              highScore: highScore,
            });
...
export default ZielenTraining2;
