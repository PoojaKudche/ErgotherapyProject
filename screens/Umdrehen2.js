...
const Umdrehen2 = ({ navigation, route }) => {
      ...
      <View style={styles.footer}>
        ...
        {disable === "Testing" ? (
          ...
          <View>
            ...
            <Text style={styles.para_text}>
              Drehen Sie gleich die Unterlegscheiben immer wieder um und zählen
              Ihre Durchgänge.
            </Text>
            <Image
            ...
            <TouchableOpacity
              style={styles.btn_submit}
              onPress={() => {
                navigation.navigate("Umdrehen3", { id: id, name: "Umdrehen" });
              }}
              // onPress={() => {
              //   navigation.navigate("ZielenTrainingExercise", { id: id });
              // }}
